...
const LanguageSelector = (props) => {
    ...
    return (
        <>
            <label htmlFor="Select Language" style={{padding: '5px', fontSize: '10px'}}>Select Language</label>
            <select className="form-select" aria-label="Default select example" name="Select Language"
                ...
                <option value={3} selected={langValue === 3}>English</option>
